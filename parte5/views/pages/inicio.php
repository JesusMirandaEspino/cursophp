            ...
            <tr>
                ...
                <td>
                    <div class="btn-group">
                        ...
                        <div class="px-1">
                            <a href="index.php?pages=editar&token=<?php echo $valor['token']; ?>" class="btn btn-warning"> <i class="fas fa-pencil-alt"></i> </a>
                        </div>

                        <div class="px-1">
                            <form action="" method="post">
                                <input type="hidden" name="eliminarRegistro" value="<?php echo $valor['token']; ?>">
